 ...
 * Kerala Police | Powered by Google Gemini (FREE)
 *
 * SETUP ON RENDER.COM:
...
:root{--navy:#0B1E3D;--navy-mid:#112848;--gold:#C9A84C;--gold-light:#E8C86A;--gold-dim:#8A6F32;--khaki:#D4C49A;--red:#E84545;--green:#3DBE7A;--white:#F4F0E8;--grey:#8A96A8;--card:#0E2444;--border:rgba(201,168,76,0.25);}
*{box-sizing:border-box;margin:0;padding:0;}
body{background:var(--navy);color:var(--white);font-family:'Inter',sans-serif;min-height:100vh;}
header{background:linear-gradient(135deg,#060F1E,var(--navy-mid));border-bottom:2px solid var(--gold);padding:14px 20px;display:flex;align-items:center;gap:14px;position:sticky;top:0;z-index:100;box-shadow:0 4px 24px rgba(0,0,0,0.5);}
.logo{width:48px;height:48px;flex-shrink:0;}
.ht h1{font-family:'Rajdhani',sans-serif;font-size:1.7rem;font-weight:700;color:var(--gold);letter-spacing:0.12em;line-height:1;}
.ht p{font-size:0.62rem;color:var(--khaki);letter-spacing:0.18em;text-transform:uppercase;margin-top:3px;}
.hr{margin-left:auto;display:flex;align-items:center;gap:10px;}
.badge{background:rgba(201,168,76,0.12);border:1px solid var(--gold-dim);color:var(--gold-light);font-family:'Rajdhani',sans-serif;font-size:0.7rem;font-weight:600;letter-spacing:0.1em;padding:4px 10px;border-radius:4px;text-transform:uppercase;}
.btn-print{background:transparent;border:1.5px solid var(--gold-dim);color:var(--gold);font-family:'Rajdhani',sans-serif;font-size:0.85rem;font-weight:600;padding:6px 14px;border-radius:6px;cursor:pointer;display:none;align-items:center;gap:6px;}
...
.node{width:32px;height:32px;border-radius:50%;background:var(--navy-mid);border:2px solid var(--gold);display:flex;align-items:center;justify-content:center;font-family:'Rajdhani',sans-serif;font-weight:700;font-size:0.85rem;color:var(--gold);transition:all 0.3s;}
.node.on{background:var(--gold);color:var(--navy);box-shadow:0 0 16px rgba(201,168,76,0.5);}
.vline{width:2px;flex:1;min-height:24px;background:linear-gradient(to bottom,var(--gold-dim),transparent);margin:4px 0;}
.cnt{flex:1;padding-bottom:28px;}
.stitle{font-family:'Rajdhani',sans-serif;font-size:1.05rem;font-weight:700;color:var(--gold-light);letter-spacing:0.05em;text-transform:uppercase;margin-bottom:4px;display:block;}
.card{background:var(--card);border:1px solid var(--border);border-radius:12px;padding:20px;margin-top:10px;}
.clabel{font-family:'Rajdhani',sans-serif;font-size:0.68rem;font-weight:600;letter-spacing:0.2em;text-transform:uppercase;color:var(--gold-dim);margin-bottom:8px;}
textarea{width:100%;min-height:180px;background:rgba(255,255,255,0.04);border:1.5px solid var(--border);border-radius:8px;color:var(--white);font-family:'Inter',sans-serif;font-size:0.95rem;line-height:1.7;padding:14px;resize:vertical;outline:none;transition:border-color 0.2s;}
...
.btn-go{margin-top:16px;width:100%;padding:16px;background:linear-gradient(135deg,var(--gold),var(--gold-dim));border:none;border-radius:10px;color:var(--navy);font-family:'Rajdhani',sans-serif;font-size:1.15rem;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:10px;box-shadow:0 4px 20px rgba(201,168,76,0.25);}
.btn-go:disabled{background:linear-gradient(135deg,#4A3F24,#2E2515);color:#7A6D4A;cursor:not-allowed;box-shadow:none;}
.btn-new{width:100%;padding:12px;margin-top:12px;background:transparent;border:1.5px solid var(--border);border-radius:8px;color:var(--gold);font-family:'Rajdhani',sans-serif;font-size:1rem;font-weight:600;cursor:pointer;}
.loading{display:none;text-align:center;padding:32px 20px;}
.spinner{width:44px;height:44px;border:3px solid rgba(201,168,76,0.2);border-top-color:var(--gold);border-radius:50%;animation:spin 0.9s linear infinite;margin:0 auto 14px;}
...
.panel{display:none;}
.sbox{background:rgba(201,168,76,0.07);border:1px solid var(--border);border-radius:8px;padding:14px 16px;font-size:0.88rem;color:var(--khaki);line-height:1.7;margin-bottom:12px;}
.meta{display:flex;gap:8px;flex-wrap:wrap;margin-bottom:12px;}
.pill{font-family:'Rajdhani',sans-serif;font-size:0.75rem;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;padding:4px 12px;border-radius:20px;border:1px solid;}
...
.note{background:rgba(232,69,69,0.07);border:1px solid rgba(232,69,69,0.2);border-left:3px solid var(--red);border-radius:6px;padding:8px 12px;font-size:0.82rem;color:#E87575;line-height:1.5;}
.sgrid{display:flex;flex-direction:column;gap:10px;margin-top:4px;}
...
.ptag{display:inline-block;font-size:0.6rem;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;padding:2px 7px;border-radius:3px;margin-bottom:8px;}
...
.shead{display:flex;align-items:flex-start;gap:10px;margin-bottom:4px;flex-wrap:wrap;}
.scode{font-family:monospace;font-size:0.8rem;font-weight:500;color:var(--gold);background:rgba(201,168,76,0.1);padding:2px 8px;border-radius:4px;white-space:nowrap;}
...
.plabel{font-family:'Rajdhani',sans-serif;font-size:0.7rem;font-weight:600;letter-spacing:0.15em;text-transform:uppercase;color:var(--gold-dim);padding:10px 0 6px;border-bottom:1px solid rgba(201,168,76,0.1);margin-bottom:8px;}
.chk{display:flex;align-items:flex-start;gap:12px;padding:10px 12px;background:rgba(255,255,255,0.025);border-radius:7px;cursor:pointer;}
.chk.done{opacity:0.55;}
.chk.done .ctxt{text-decoration:line-through;}
.cbox{width:22px;height:22px;border:2px solid var(--gold-dim);border-radius:5px;flex-shrink:0;display:flex;align-items:center;justify-content:center;margin-top:1px;}
...
.curg{font-size:0.6rem;font-weight:600;text-transform:uppercase;color:var(--red);background:rgba(232,69,69,0.1);border:1px solid rgba(232,69,69,0.25);padding:2px 6px;border-radius:3px;margin-top:3px;display:inline-block;}
.prow{display:flex;justify-content:space-between;align-items:center;margin-top:10px;}
.pbar{height:4px;background:rgba(255,255,255,0.07);border-radius:2px;margin-top:8px;overflow:hidden;}
.pfill{height:100%;background:linear-gradient(to right,var(--gold-dim),var(--green));border-radius:2px;transition:width 0.3s;}
.ptxt{font-size:0.75rem;color:var(--grey);}
.pnum{font-family:monospace;font-size:0.78rem;color:var(--gold);}
.disc{background:rgba(232,69,69,0.06);border:1px solid rgba(232,69,69,0.2);border-radius:8px;padding:12px 14px;font-size:0.75rem;color:#E87575;line-height:1.6;margin-top:10px;display:flex;gap:8px;}
.err{background:rgba(232,69,69,0.08);border:1px solid rgba(232,69,69,0.3);border-radius:8px;padding:14px;color:#E87575;font-size:0.85rem;line-height:1.6;display:none;margin-top:12px;gap:8px;}
.phdr{display:none;}
.pftr{display:none;}
.pbox{display:none;}
@media print{
  ...
  header,.btn-go,.btn-new,.btn-print,textarea,.hint,.loading,.cbox,.ctick,.disc,.spine,.pbar,.prow,#step1,.err{display:none!important;}
  main{padding:0!important;max-width:100%!important;}
  .phdr{display:block!important;text-align:center;border-bottom:2.5pt solid #8B6914;padding-bottom:10pt;margin-bottom:14pt;}
  .phdr h1{font-size:18pt;font-weight:900;color:#8B6914;letter-spacing:0.1em;}
  .phdr h2{font-size:8pt;color:#555;letter-spacing:0.15em;text-transform:uppercase;}
  .phdr .pm{font-size:8pt;color:#444;margin-top:6pt;}
  .phdr .pd{height:1pt;background:#ddd;margin:6pt 0;}
  .card{background:white!important;border:1pt solid #ccc!important;padding:10pt!important;margin-top:8pt!important;page-break-inside:avoid;}
  .clabel{color:#8B6914!important;font-size:7pt!important;}
  .step{display:block!important;}
  .cnt{padding-bottom:0!important;}
  .stitle{color:#222!important;font-size:11pt!important;margin-bottom:4pt;}
  .sbox{background:#FAFAF5!important;color:#222!important;font-size:9.5pt!important;padding:8pt!important;}
  ...
  .scode{background:#f0f0f0!important;color:#333!important;}
  .sname{color:#111!important;}
  ...
  .curg{color:#CC3333!important;background:#FFF0F0!important;font-size:7pt!important;}
  ...
  .note{background:#FFF8F8!important;color:#AA2222!important;font-size:9pt!important;}
  .panel{display:block!important;}
  .pftr{display:block!important;margin-top:16pt;border-top:1pt solid #ccc;padding-top:8pt;font-size:7pt;color:#888;text-align:center;}
}
</style>
</head>
<body>
...
<main>
  <div class="step" id="step1">
    ...
    <div class="cnt">
      <span class="stitle">Enter First Information Statement</span>
      <div class="card">
        <div class="clabel">Complaint / FIS Details</div>
        <textarea id="firInput" placeholder="Describe the incident in your own words...

Example: On 12/06/2026 at 9 PM, the complainant states that the accused entered her house without permission, threatened her with a knife demanding money, and slapped her causing injury. Neighbours witnessed the incident."></textarea>
  ...
  <div class="step">
    ...
    <div class="cnt">
      <span class="stitle">AI Legal Analysis</span>
      ...
      <div class="card panel" id="summaryPanel">
        ...
        <div class="sbox" id="summaryTxt"></div>
  ...
  <div class="step">
    <div class="spine">
      ...
      <div class="vline" style="background:transparent"></div>
    </div>
    <div class="cnt">
      <span class="stitle">Duty Checklist</span>
      <div class="card panel" id="chkPanel">
        <div class="clabel">Procedures &amp; Officer Duties</div>
        <div class="prow">
          <span class="ptxt">Tap items to mark complete</span>
          <span class="pnum" id="progNum">0 / 0</span>
        </div>
        <div class="pbar"><div class="pfill" id="progFill" style="width:0%"></div></div>
        <div class="chklist" id="chkList" style="margin-top:16px"></div>
...
async function analyse(){
  ...
  hideErr();lastStmt=stmt;setLoad(true);
  try{
    ...
    setLoad(false);render(d);
  }catch(err){setLoad(false);showErr(err.message||'Could not connect. Please try again.');}
}
...
function render(d){
  ...
  (d.sections||[]).forEach(s=>{
    ...
    div.innerHTML='<span class="ptag '+tc+'">'+e(tl)+'</span><div class="shead"><span class="scode">'+e(s.code)+'</span><span class="sname">'+e(s.name)+'</span></div><div class="slaw">'+e(s.law||'')+'</div>'+(s.old_ref?'<div class="sold">Old ref: '+e(s.old_ref)+'</div>':'')+(s.punishment?'<div class="spun">⚖ Punishment: '+e(s.punishment)+'</div>':'')+'<div class="sdesc">'+e(s.description)+'</div>';
    sg.appendChild(div);
  });
  show('secPanel');
  items=[];done=new Set();
  ...
  (d.checklist||[]).forEach(ph=>{
    ...
    (ph.items||[]).forEach(it=>{
      ...
      row.innerHTML='<div class="cbox"><span class="ctick">✓</span></div><div class="pbox"></div><div style="flex:1"><div class="ctxt">'+e(it.task)+'</div>'+(it.urgent?'<span class="curg">⚡ Urgent</span>':'')+'</div>';
      pd.appendChild(row);
    });
    cl.appendChild(pd);
  });
...
function tick(i){const el=document.getElementById('c'+i);if(done.has(i)){done.delete(i);el.classList.remove('done');}else{done.add(i);el.classList.add('done');}prog();}
function prog(){const t=items.length,d=done.size;document.getElementById('progNum').textContent=d+' / '+t;document.getElementById('progFill').style.width=t>0?(d/t*100)+'%':'0%';}
function setLoad(on){document.getElementById('loading').style.display=on?'block':'none';document.getElementById('goBtn').disabled=on;if(on)document.getElementById('n2').classList.add('on');}
...
function callGemini(statement){
  return new Promise((resolve,reject)=>{
    const prompt=`You are a senior legal expert in Indian criminal law advising Kerala Police officers.
Analyse this First Information Statement and respond ONLY with valid JSON — no markdown, no extra text.
  ...
  "checklist": [
    {
      ...
      "items": [{"task": "Specific duty to perform", "urgent": true}]
    },
    {
...
- Use BNS 2023 section numbers. Note old IPC equivalent in old_ref
- Add POCSO if victim is minor, DV Act for domestic violence, SC/ST Act if applicable
- 12 to 18 checklist items total, specific to this exact case type
- cognizable and bailable based on the most serious primary charge
- important_notes: 1 to 3 special warnings relevant to this case
- Plain simple English suitable for a police trainee`;
    ...
    const req=https.request(options,res=>{
      ...
      res.on('end',()=>{
        ...
        }catch(err){reject(new Error('Could not parse AI response. Please try again.'));}
      });
    });
    req.on('error',reject);
    req.write(body);
...
const server=http.createServer(async(req,res)=>{
  ...
  if(req.method==='POST'&&path==='/analyse'){
    if(!API_KEY){
      ...
      res.end(JSON.stringify({error:'API key not set. Please add GEMINI_API_KEY in Render environment variables.'}));
      return;
    }
    try{
      ...
      if(!statement||statement.trim().length<20){
        ...
        res.end(JSON.stringify({error:'Please provide more details about the incident.'}));
        return;
      }
      const data=await callGemini(statement.trim());
...
server.listen(PORT,'0.0.0.0',()=>{
  console.log('');
  console.log('╔══════════════════════════════════════════════════╗');
  console.log('║   SUTRA – Kerala Police  |  Powered by Gemini   ║');
  console.log('╠══════════════════════════════════════════════════╣');
  console.log('║   Open:  http://localhost:'+PORT+'                    ║');
  console.log('╠══════════════════════════════════════════════════╣');
  console.log(API_KEY
    ?'║   ✅  Gemini API key loaded. Ready!              ║'
    :'║   ⚠️   No API key! Set GEMINI_API_KEY            ║');
  console.log('╚══════════════════════════════════════════════════╝');
  console.log('');
});
